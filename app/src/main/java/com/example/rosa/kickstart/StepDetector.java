package com.example.rosa.kickstart;

import com.example.rosa.kickstart.activity.SensorFilter;
...
public class StepDetector {
    ...
    private static final float STEP_TRESHOLD = 50f;
    ...
    public void updateAccel(long timeNs, float x, float y, float z){
        ...
        if (velocityEstimate > STEP_TRESHOLD && oldVelocityEstimate <= STEP_TRESHOLD &&
